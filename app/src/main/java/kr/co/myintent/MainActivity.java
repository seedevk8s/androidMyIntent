...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final String[] imagName = {"독서하는 소녀", "꽂장식 소녀", "부채를 든 소녀", "이레느깡 단 베르양", "잠자는 소녀",
        ...
        for (int i = 0; i < imageId.length; i++) {
            ...
            imageView[index].setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    //투표수 증가
                    voteCount[index]++;
                    Toast.makeText(getApplicationContext(), imagName[index] +": 총 "+ voteCount[index]+ " 표", Toast.LENGTH_SHORT).show();
                }
            });
        }
